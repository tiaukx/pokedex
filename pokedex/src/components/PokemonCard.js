...
const PokemonCard = (props) => {
    ...
    return (
        <>
            <Card style={{ height: '28rem', width: '17rem', border: 'black', textAlign: "center", fontFamily: "futura" }} className='pulse-card mx-1 my-1'>
                            ...
                            </Col>
                            {
                                type1 === type2 
                                    ...
                                    : <Col className='type2'>
                                        ...
                                        {<><img className="type-icon" src={pokemonIcon[type2]} alt={`${type2}`} style={{ width: '2rem' }} /></>}{' '}
